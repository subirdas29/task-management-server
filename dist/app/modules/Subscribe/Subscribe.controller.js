...
const createSubscribeController = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    // const {email} = req.user;
    const result = yield Subscribe_service_1.SubscribeService.createSubscribe(req.body);
